...
INSERT INTO `elements` VALUES (1,1,'TituloTeste');
...
INSERT INTO `elmproperties` VALUES (1,'Title','Pai');
...
CREATE TABLE `emojimenu` (
  ...
  CONSTRAINT `emojimenu_ibfk_2` FOREIGN KEY (`id_icon`) REFERENCES `icons` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `emojimenu` VALUES (1,1,1);
...
INSERT INTO `emojis` VALUES (1,'Emoji sorridente','😁');
...
INSERT INTO `pages` VALUES (1,1,1,1,1),(2,1,1,1,1);
...
-- Dump completed on 2024-04-26 17:11:53
